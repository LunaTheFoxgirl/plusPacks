...
GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"012", "345", "678", Character.valueOf('0'), new ItemStack(Blocks.end_stone, 1), Character.valueOf('1'), new ItemStack(Items.ender_pearl, 1), Character.valueOf('2'), new ItemStack(Blocks.end_stone, 1), Character.valueOf('3'), new ItemStack(Items.ender_pearl, 1), Character.valueOf('4'), new ItemStack(Blocks.tnt, 1), Character.valueOf('5'), new ItemStack(Items.ender_pearl, 1), Character.valueOf('6'), new ItemStack(Blocks.end_stone, 1), Character.valueOf('7'), new ItemStack(Items.ender_pearl, 1), Character.valueOf('8'), new ItemStack(Blocks.end_stone, 1), 
});
}
...
if(true){
Entity sentity = EntityList.createEntityByID(58, world);if (sentity != null){sentity.setLocationAndAngles(i, j + 1, k, world.rand.nextFloat() * 360F, 0.0F);world.spawnEntityInWorld(sentity);((EntityLiving)sentity).playLivingSound();}
}

if(true){
Entity sentity = EntityList.createEntityByID(58, world);if (sentity != null){sentity.setLocationAndAngles(i, j + 2, k, world.rand.nextFloat() * 360F, 0.0F);world.spawnEntityInWorld(sentity);((EntityLiving)sentity).playLivingSound();}
}

if(true){
Entity sentity = EntityList.createEntityByID(58, world);if (sentity != null){sentity.setLocationAndAngles(i, j + 3, k, world.rand.nextFloat() * 360F, 0.0F);world.spawnEntityInWorld(sentity);((EntityLiving)sentity).playLivingSound();}
}
