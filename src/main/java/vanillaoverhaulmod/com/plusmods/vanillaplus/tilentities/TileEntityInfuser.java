...
public class TileEntityInfuser extends TileEntityFurnace implements ISidedInventory
{
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack = InfuserRecipes.infusing().getSmeltingResult(this.furnaceItemStacks[0]);
