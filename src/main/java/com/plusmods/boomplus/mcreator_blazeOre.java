...
.setBlockTextureName("blazeOretexture")
.setLightOpacity(0)
...
(new WorldGenMinable(mcreator_blazeOre.block, 12)).generate(world, rand, randPosX, randPosY, randPosZ);
}
}
...
this.gor = reg.registerIcon("blazeOretexture");
this.dol = reg.registerIcon("blazeOretexture");
this.st1 = reg.registerIcon("blazeOretexture");
this.st2 = reg.registerIcon("blazeOretexture");
this.st3 = reg.registerIcon("blazeOretexture");
this.st4 = reg.registerIcon("blazeOretexture");
}
