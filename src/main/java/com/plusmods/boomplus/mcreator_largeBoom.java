...
GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"012", "345", "678", Character.valueOf('0'), new ItemStack(Blocks.tnt, 1), Character.valueOf('1'), new ItemStack(Blocks.tnt, 1), Character.valueOf('2'), new ItemStack(Blocks.tnt, 1), Character.valueOf('3'), new ItemStack(Blocks.tnt, 1), Character.valueOf('4'), new ItemStack(Blocks.wool, 1, 10), Character.valueOf('5'), new ItemStack(Blocks.tnt, 1), Character.valueOf('6'), new ItemStack(Blocks.tnt, 1), Character.valueOf('7'), new ItemStack(Blocks.tnt, 1), Character.valueOf('8'), new ItemStack(Blocks.tnt, 1), 
});
}
...
.setBlockTextureName("largeBoomtexture")
.setLightOpacity(0)
