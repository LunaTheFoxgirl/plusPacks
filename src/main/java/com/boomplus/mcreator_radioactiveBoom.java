...
GameRegistry.addRecipe(new ItemStack(block, 1), new Object[]{
	"012", "345", "678", Character.valueOf('0'), new ItemStack(Blocks.tnt, 1), Character.valueOf('1'), new ItemStack(mcreator_radGunpowder.block, 1), Character.valueOf('2'), new ItemStack(Blocks.tnt, 1), Character.valueOf('3'), new ItemStack(mcreator_radGunpowder.block, 1), Character.valueOf('4'), new ItemStack(Blocks.tnt, 1), Character.valueOf('5'), new ItemStack(mcreator_radGunpowder.block, 1), Character.valueOf('6'), new ItemStack(Blocks.tnt, 1), Character.valueOf('7'), new ItemStack(mcreator_radGunpowder.block, 1), Character.valueOf('8'), new ItemStack(Blocks.tnt, 1), 
});
}
...
block = (BlockRadioactiveBoom)(new BlockRadioactiveBoom().setHardness(2.0F)
.setResistance(0.0F)
.setLightLevel(0.0F)
.setBlockName("RadioactiveBoom")
.setBlockTextureName("radioactiveBoomtexture")
.setLightOpacity(0)
