...
public class BoomPlus implements IFuelHandler, IWorldGenerator{
	...
	@SidedProxy(clientSide="mod.mcreator.ClientProxyBoomPlus", serverSide="mod.mcreator.CommonProxyBoomPlus")
    //@SidedProxy(clientSide="mod.mcreator.ClientProxyBoomPlus", serverSide="mod.mcreator.CommonProxyBoomPlus")
    public static CommonProxyBoomPlus proxy;
    //public static EnumMap<Side, FMLEmbeddedChannel> channels = NetworkRegistry.INSTANCE.newChannel("MCRBUS", new ChannelHandlerBoomPlus());
...
if(id == mcreator_welcomeGUI.GUIID)return new mcreator_welcomeGUI.GuiContainerMod(player);
return null;}
@Override public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
if(id == mcreator_welcomeGUI.GUIID)return new mcreator_welcomeGUI.GuiWindow(world, x, y, z, player);
return null;}
}
