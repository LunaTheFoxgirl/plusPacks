...
public class TileEntityChestValues extends TileEntityChest implements IInventory
{
    private ItemStack[] chestContents = new ItemStack[36];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestValues adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestValues adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestValues adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityChestValues adjacentChestZPos;
    ...
    public TileEntityChestValues()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityChestValues(int p_i2350_1_)
    {
    ...
    public void readFromNBT(NBTTagCompound p_145839_1_)
    {
        ...
        isArmed = p_145839_1_.getBoolean("isArmed");
    ...
    public void writeToNBT(NBTTagCompound p_145841_1_)
    {
        ...
        p_145841_1_.setBoolean("isArmed", isArmed);
    ...
    private void func_145978_a(TileEntityChestValues p_145978_1_, int p_145978_2_)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityChestValues)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityChestValues)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityChestValues)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityChestValues)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
