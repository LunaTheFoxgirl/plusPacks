package com.plusmods.oresplus.tileentity;

import com.plusmods.oresplus.blocks.BlockRefinery;
...
public class TileEntityRefinery extends TileEntityFurnace implements ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockRefinery.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
