...
public class VanillaPlus {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		// Register Blocks
		// RedStoneBrick
		infusedOre = new InfusedOre(Material.iron)
				.setBlockName("InfusedOre").setHardness(1.0f)
				.setCreativeTab(VanillaPlusTab.tab)
				.setBlockTextureName("vanillaplus:infused_ore");
		infusedOre.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
		infusedOre.setHarvestLevel("pickaxe", 1);
